-- Config editável do Simulador de Preços (tabela singleton, JSONB).
-- Semeada com os valores exatos da planilha "Lista de Valores".
...
-- Semente (só insere se ainda não existir a linha 'default')
